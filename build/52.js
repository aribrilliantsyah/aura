...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return TabPage4; });
...
var TabPage4 = (function () {
    function TabPage4(tabsService, toastCtrl) {
        var _this = this;
        this.tabsService = tabsService;
        this.toastCtrl = toastCtrl;
        this.tabsService.load("tab4").subscribe(function (snapshot) {
            _this.params = snapshot;
        });
    }
    TabPage4.prototype.ngOnChanges = function (changes) {
        this.params = changes['data'].currentValue;
    };
    TabPage4.prototype.onItemClick = function (item) {
        this.toastCtrl.presentToast("Folow");
    };
    TabPage4 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({template:/*ion-inline-start:"/home/ari/Repos/Ionic/ClinicMobile/src/pages/tab-page-4/tab-page-4.html"*/'<!--- Settings TAB lauout-4 -->\n\n<ion-content>\n\n  <ion-list-header box-shadow header-section no-lines padding-horizontal no-margin *ngIf="params != null">\n\n      <h1 header-title text-capitalize>{{params.header}}</h1>\n\n  </ion-list-header>\n\n    <ion-list tabPage4 *ngIf="params != null">\n\n        <ion-item border no-lines *ngFor="let item of params.items; let i = index;" (click)="onItemClick(item)">\n\n            <ion-avatar item-start>\n\n                <img [src]="item.avatar" />\n\n            </ion-avatar>\n\n            <h2 item-title>{{item.title}}</h2>\n\n            <h3 item-subtitle text-wrap>{{item.subtitle}}</h3>\n\n            <button text-capitalize button-follow ion-button item-end>{{item.follow}}</button>\n\n        </ion-item>\n\n    </ion-list>\n\n</ion-content>\n\n'/*ion-inline-end:"/home/ari/Repos/Ionic/ClinicMobile/src/pages/tab-page-4/tab-page-4.html"*/,
...
//# sourceMappingURL=tab-page-4.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TabPage4Module", function() { return TabPage4Module; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__tab_page_4__ = __webpack_require__(1135);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var TabPage4Module = (function () {
    function TabPage4Module() {
    }
    TabPage4Module = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__tab_page_4__["a" /* TabPage4 */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["IonicPageModule"].forChild(__WEBPACK_IMPORTED_MODULE_2__tab_page_4__["a" /* TabPage4 */]),
            ],
            exports: [
                __WEBPACK_IMPORTED_MODULE_2__tab_page_4__["a" /* TabPage4 */]
            ]
    ...
    return TabPage4Module;
}());

//# sourceMappingURL=tab-page-4.module.js.map

...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return TabPage11; });
...
var TabPage11 = (function () {
    function TabPage11(tabsService, toastCtrl) {
        ...
        this.tabsService.load("tab11").subscribe(function (snapshot) {
            _this.params = snapshot;
        });
    }
    TabPage11.prototype.ngOnChanges = function (changes) {
        this.params = changes['data'].currentValue;
    };
    TabPage11.prototype.onItemClick = function (item) {
        this.toastCtrl.presentToast("Get");
    };
    TabPage11 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({template:/*ion-inline-start:"/home/ari/Repos/Ionic/ClinicMobile/src/pages/tab-page-11/tab-page-11.html"*/'<!--- Settings TAB lauout-11-->\n\n<ion-content>\n\n    <ion-list tabPage11 *ngIf="params != null">\n\n        <ion-item padding-bottom padding-top border no-lines *ngFor="let item of params.items; let i = index;" (click)="onItemClick(item)">\n\n            <ion-thumbnail item-start>\n\n                <img [src]="item.avatar" />\n\n            </ion-thumbnail>\n\n            <h2 item-title>{{item.title}}</h2>\n\n            <h3 item-subtitle text-wrap>{{item.subtitle}}</h3>\n\n            <ion-badge text-uppercase badge-light>{{item.price}}</ion-badge>\n\n        </ion-item>\n\n    </ion-list>\n\n</ion-content>\n\n'/*ion-inline-end:"/home/ari/Repos/Ionic/ClinicMobile/src/pages/tab-page-11/tab-page-11.html"*/,
...
//# sourceMappingURL=tab-page-11.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__tab_page_11__ = __webpack_require__(1129);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var TabPage11Module = (function () {
    ...
    TabPage11Module = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__tab_page_11__["a" /* TabPage11 */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["IonicPageModule"].forChild(__WEBPACK_IMPORTED_MODULE_2__tab_page_11__["a" /* TabPage11 */]),
            ],
            exports: [
                __WEBPACK_IMPORTED_MODULE_2__tab_page_11__["a" /* TabPage11 */]
            ]
    ...
    return TabPage11Module;
}());

//# sourceMappingURL=tab-page-11.module.js.map

...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return IndexProfilePage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_loading_service_loading_service__ = __webpack_require__(500);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_toast_service_toast_service__ = __webpack_require__(501);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ionic_native_photo_viewer__ = __webpack_require__(527);
...
var IndexProfilePage = (function () {
    function IndexProfilePage(navCtrl, navParams, profileService, auth, loading, events, toast, storage, action, photoViewer) {
        ...
        this.init = {
            data: {
                "default_avatar": "assets/images/avatar/default-user.png",
            }
        };
        //middleware Auth 
        this.auth.AuthCheck(this.token);
    }
    IndexProfilePage.prototype.doRefresh = function (refresher) {
    ...
    IndexProfilePage.prototype.ionViewDidEnter = function () {
        var _this = this;
        this.storage.get('token').then(function (token) {
            if (token != undefined || token != null) {
                _this.token = token;
                console.log('ini w', token);
                _this.getProfile(_this.token);
            }
        });
    };
    IndexProfilePage.prototype.ionViewDidLoad = function () {
        var feedback = this.navParams.get('feedback');
        if (feedback) {
            this.toast.show(feedback);
        }
    };
    IndexProfilePage.prototype.getProfile = function (token) {
        var _this = this;
        var loader = this.loading.show('Please Wait ....');
        loader.present().then(function () {
            _this.profileService.profileInfo(token).subscribe(function (data) { _this.profile = data.data, _this.setFoto(); }, function (error) { return _this.error(error, loader); }, function () { return loader.dismiss(); });
        });
    };
    IndexProfilePage.prototype.setFoto = function () {
        var timeStamp = Math.floor(Date.now());
        this.foto = this.profile.foto + "?ts=" + timeStamp;
    };
    IndexProfilePage.prototype.error = function (error, l) {
        var _this = this;
        l.dismiss().then(function () {
            _this.toast.show('Server Busy, Please try again');
        });
    };
    IndexProfilePage.prototype.ngAfterViewInit = function () {
        this.subscribeToIonScroll();
    };
    IndexProfilePage.prototype.isClassActive = function () {
        return this.active;
    };
    IndexProfilePage.prototype.subscribeToIonScroll = function () {
        var _this = this;
    ...
    IndexProfilePage.prototype.edit = function () {
        this.navCtrl.push('EditProfilePage', {
            token: this.token,
        });
    };
    IndexProfilePage.prototype.clickFoto = function () {
        var _this = this;
    ...
    IndexProfilePage.prototype.changeFoto = function () {
        this.navCtrl.push('PhotoProfilePage', {
            token: this.token,
        });
    };
    IndexProfilePage.prototype.detailFoto = function () {
        var timeStamp = Math.floor(Date.now());
        this.foto = this.profile.foto + "?ts=" + timeStamp;
        this.photoViewer.show(this.foto, '', { share: true });
    };
    IndexProfilePage.prototype.deleteFoto = function () {
        var _this = this;
        var loader = this.loading.show('Please Wait ....');
        loader.present().then(function () {
            _this.profileService.deleteFoto(_this.token).subscribe(function (data) {
                _this.toast.show('Berhasil Menghapus');
                _this.setFoto();
                _this.events.publish('foto:update', Math.floor(Date.now()));
            }, function (error) {
                loader.dismiss().then(function () {
                    _this.toast.show('Error Proccess');
                });
    ...
    ], IndexProfilePage.prototype, "content", void 0);
    IndexProfilePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-index-profile',template:/*ion-inline-start:"/home/ari/Repos/Ionic/ClinicMobile/src/pages/index-profile/index-profile.html"*/'<!-- Content -->\n<ion-header header-ios>\n  <ion-navbar [ngClass]="{\'active\':true}">\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Profile</ion-title>\n    <!-- notif -->\n    <ion-buttons end>\n      <button ion-button clear icon-only>\n        <ion-icon name="notifications">\n          <notifications></notifications>\n        </ion-icon>              \n      </button>\n    </ion-buttons>\n  </ion-navbar>\n</ion-header>\n\n<ion-content elastic-header>\n  \n<!--   <ion-refresher (ionRefresh)="doRefresh($event)">\n    <ion-refresher-content\n      pullingIcon="arrow-dropdown"\n      pullingText="Pull to refresh"\n      refreshingSpinner="circles"\n      refreshingText="Refreshing...">\n    </ion-refresher-content>\n  </ion-refresher> -->\n\n  <div padding background-size box-shadow id="elastic-header" [ngStyle]="{\'background-image\': \'url(assets/images/background/45.png)\'}">\n    <!--- Info Block -->\n    <div info-block padding-horizontal *ngIf="profile != undefined else default">\n      <!-- Avatar -->\n      <ion-thumbnail>\n        <img [src]="foto" (click)="clickFoto()"/>\n      </ion-thumbnail>\n      <!-- Parallx Title -->\n      <h2 text-center parallax-title>{{profile.title}}</h2>\n      <!-- Parallx Subtitle -->\n      <h3 text-center parallax-subtitle>{{profile.nama}}</h3>\n    </div>\n  </div>\n\n  <ion-list>\n    <user-profile [profile]="profile"></user-profile>\n  </ion-list>\n\n  <ion-fab right bottom>\n    <button ion-fab (click)="edit()">\n      <ion-icon name="md-create"></ion-icon>\n    </button>\n  </ion-fab>\n\n</ion-content>\n\n\n<ng-template #default>\n  <div info-block padding-horizontal>\n    <!-- Avatar -->\n    <ion-thumbnail *ngIf="init.data != undefined">\n      <img [src]="init.data.default_avatar"/>\n    </ion-thumbnail>\n    <!-- Parallx Title -->\n    <h2 text-center parallax-title>-</h2>\n    <!-- Parallx Subtitle -->\n    <h3 text-center parallax-subtitle>-</h3>\n  </div>\n</ng-template>'/*ion-inline-end:"/home/ari/Repos/Ionic/ClinicMobile/src/pages/index-profile/index-profile.html"*/,
        }),
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "IndexProfilePageModule", function() { return IndexProfilePageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__index_profile__ = __webpack_require__(1084);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(518);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_elastic_header_elastic_header_module__ = __webpack_require__(875);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_ion_affix__ = __webpack_require__(891);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var IndexProfilePageModule = (function () {
    function IndexProfilePageModule() {
    }
    IndexProfilePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__index_profile__["a" /* IndexProfilePage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["IonicPageModule"].forChild(__WEBPACK_IMPORTED_MODULE_2__index_profile__["a" /* IndexProfilePage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
                __WEBPACK_IMPORTED_MODULE_4__components_elastic_header_elastic_header_module__["a" /* ElasticHeaderModule */],
                __WEBPACK_IMPORTED_MODULE_5_ion_affix__["a" /* IonAffixModule */]
            ],
        })
    ], IndexProfilePageModule);
    return IndexProfilePageModule;
}());

//# sourceMappingURL=index-profile.module.js.map

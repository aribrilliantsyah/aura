...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return HistoryReservasiPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ionic_storage__ = __webpack_require__(73);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ionic_angular__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_modal_service_modal_service__ = __webpack_require__(121);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_reservasi_service_reservasi_service__ = __webpack_require__(520);
...
var HistoryReservasiPage = (function () {
    function HistoryReservasiPage(navCtrl, navParams, profileService, auth, loading, events, toast, modal, reservasi, storage, app) {
    ...
    HistoryReservasiPage.prototype.reload = function (refresher) {
        this.page = 1;
        this.reservasiHistory = [];
    ...
    HistoryReservasiPage.prototype.ionViewDidEnter = function () {
        var _this = this;
        console.log('wow');
        this.page = 1;
        this.range.from = null;
        ...
        this.storage.get('token').then(function (token) {
            if (token != undefined || token != null) {
                _this.reservasiHistory = [];
                _this.loadList('', token);
            }
        });
    };
    HistoryReservasiPage.prototype.loadList = function (infiniteScroll, token, range) {
        var _this = this;
        if (range) {
            this.token = token;
            this.reservasi.get_history_reservasi(token, range.from, range.to, this.page).subscribe(function (data) {
                _this.reservasiHistory = _this.reservasiHistory.concat(data['data']);
                _this.maxPage = data.totalPage;
            }, function (error) { return console.log('error mz wk: press "F"'); }, function () { return ''; });
        }
        else {
            this.token = token;
            this.reservasi.get_history_reservasi(token, '', '', this.page).subscribe(function (data) {
                _this.reservasiHistory = _this.reservasiHistory.concat(data['data']);
                _this.maxPage = data.totalPage;
            }, function (error) { return console.log('error mz wk: press "F"'); }, function () { return ''; });
        }
    ...
    HistoryReservasiPage.prototype.loadMore = function (infiniteScroll) {
        var _this = this;
        setTimeout(function () {
            _this.page++;
            if (_this.range.from && _this.range.to) {
                _this.loadList(infiniteScroll, _this.token, _this.range);
            }
            else {
    ...
    HistoryReservasiPage.prototype.onChange = function (type) {
        if (type == 'from') {
            this.c_to = false;
            this.min_to = this.range.from;
            if (this.range.to) {
                this.reservasiHistory = [];
                this.page = 1;
                this.loadList('', this.token, this.range);
            }
        }
        else {
            this.page = 1;
    ...
    ;
    HistoryReservasiPage.prototype.color = function (status) {
        if (status == "Canceled") {
            return "orange";
        }
    ...
    ], HistoryReservasiPage.prototype, "content", void 0);
    HistoryReservasiPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-history-reservasi',template:/*ion-inline-start:"/home/ari/Repos/Ionic/ClinicMobile/src/pages/history-reservasi/history-reservasi.html"*/'\n\n<!-- <ion-header box-shadow>\n  <ion-navbar box-shadow>\n    <button ion-button menuToggle>\n        <ion-icon name="menu"></ion-icon>\n      </button>\n    <ion-title></ion-title>\n  </ion-navbar>\n</ion-header> -->\n\n<ion-content>\n	<ion-refresher (ionRefresh)="reload($event)">\n	  <ion-refresher-content></ion-refresher-content>\n	</ion-refresher>\n 	<ion-list no-margin>\n    	<!-- Header Top -->\n<!-- 	    <ion-grid no-padding ion-affix\n	        [content]="content">\n		   	<ion-row no-padding class="bg-ion-row">\n		    	<ion-col no-padding>\n		      		<ion-item no-lines>\n						<ion-datetime displayFormat="MM/DD/YYYY" placeholder="From" [(ngModel)]="range.from" (ionChange)="onChange(\'from\')"></ion-datetime>\n					</ion-item>\n		    	</ion-col>\n		    	<ion-col no-padding>\n		      		<ion-item no-lines>\n						<ion-datetime displayFormat="MM/DD/YYYY" placeholder="To" [(ngModel)]="range.to" (ionChange)="onChange(\'to\')" disabled="{{c_to}}" min="{{min_to}}"></ion-datetime>\n					</ion-item>\n		    	</ion-col>\n		  	</ion-row>\n		  	<ion-list-header box-shadow no-lines mode="md">\n			   <h4 text-capitalize text-center>History Reservasi</h4>\n			</ion-list-header>\n		</ion-grid>	 -->\n\n		<ion-list *ngIf="reservasiHistory">\n		  <ion-item margin-bottom no-lines *ngFor="let item of reservasiHistory" style="margin-bottom:11px">\n		  	<ion-card padding style="border-radius:5px;margin-bottom:3px;">\n			    <!-- Title -->\n			    <h2 item-title>{{item.unit_usaha}}</h2>\n			    <!-- Subtitle -->\n			    <h3 item-subtitle>{{item.no_reservasi}}</h3>\n			    <!-- Details Item-->\n			    <span span-medium style="margin-top:15px" float-right>{{item.tanggal}} {{item.waktu}}</span>\n			    <ion-badge float-left style="margin-top:10px" [ngStyle]="{\'background-color\': color(item.status) }">{{item.status}}</ion-badge>\n			</ion-card>\n		  </ion-item>\n		</ion-list>\n\n    </ion-list>\n	<ion-infinite-scroll (ionInfinite)="loadMore($event)">\n	  <ion-infinite-scroll-content></ion-infinite-scroll-content>\n	</ion-infinite-scroll>\n</ion-content>\n'/*ion-inline-end:"/home/ari/Repos/Ionic/ClinicMobile/src/pages/history-reservasi/history-reservasi.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["NavController"],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_modal_service_modal_service__["a" /* ModalServiceProvider */],
            __WEBPACK_IMPORTED_MODULE_8__providers_reservasi_service_reservasi_service__["a" /* ReservasiServiceProvider */],
            __WEBPACK_IMPORTED_MODULE_1__ionic_storage__["b" /* Storage */],
            __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["App"]])
    ], HistoryReservasiPage);
    return HistoryReservasiPage;
}());

//# sourceMappingURL=history-reservasi.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HistoryReservasiPageModule", function() { return HistoryReservasiPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__history_reservasi__ = __webpack_require__(1081);
...
var HistoryReservasiPageModule = (function () {
    function HistoryReservasiPageModule() {
    }
    HistoryReservasiPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__history_reservasi__["a" /* HistoryReservasiPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["IonicPageModule"].forChild(__WEBPACK_IMPORTED_MODULE_2__history_reservasi__["a" /* HistoryReservasiPage */]),
                __WEBPACK_IMPORTED_MODULE_3_ion_affix__["a" /* IonAffixModule */]
            ],
        })
    ], HistoryReservasiPageModule);
    return HistoryReservasiPageModule;
}());

//# sourceMappingURL=history-reservasi.module.js.map

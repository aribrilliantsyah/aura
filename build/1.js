...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_calendar_calendar_module__ = __webpack_require__(1075);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return __WEBPACK_IMPORTED_MODULE_0__src_calendar_calendar_module__["a"]; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__calendar__ = __webpack_require__(1076);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pipes_month_name__ = __webpack_require__(1078);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash__ = __webpack_require__(1077);
...
var Calendar = (function () {
    function Calendar() {
        this.onDaySelect = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"]();
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(46), __webpack_require__(523)(module)))
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ReservasiPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_modal_service_modal_service__ = __webpack_require__(121);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_profile_service_profile_service__ = __webpack_require__(517);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_auth_service_auth_service__ = __webpack_require__(207);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__providers_loading_service_loading_service__ = __webpack_require__(500);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_toast_service_toast_service__ = __webpack_require__(501);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__providers_reservasi_service_reservasi_service__ = __webpack_require__(520);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
 ...
 */
var ReservasiPage = (function () {
    function ReservasiPage(navCtrl, navParams, profileService, auth, loading, events, toast, modal, reservasi, storage, app) {
        ...
        this.errorsCount = 0;
        this.page = 1;
        this.currentReservasi = [];
        //middleware Auth 
        this.auth.AuthCheck(this.token);
        this.rootNavCtrl = this.navParams.get('rootNavCtrl');
    }
    ReservasiPage.prototype.reload = function (refresher) {
        this.page = 1;
        this.currentReservasi = [];
        this.loadList('', this.token);
        setTimeout(function () {
            console.log('Async operation has ended');
            refresher.complete();
        }, 2000);
    };
    ReservasiPage.prototype.ionViewDidEnter = function () {
        var _this = this;
        this.page = 1;
        this.currentReservasi = [];
        this.storage.get('token').then(function (token) {
            if (token != undefined || token != null) {
                _this.getData(token);
                _this.loadList('', token);
            }
        });
    };
    ReservasiPage.prototype.loadList = function (infiniteScroll, token) {
        var _this = this;
        this.reservasi.get_list_on_going(token, this.page).subscribe(function (data) {
            _this.currentReservasi = _this.currentReservasi.concat(data['data']);
    ...
    ReservasiPage.prototype.loadMore = function (infiniteScroll) {
        var _this = this;
        setTimeout(function () {
            _this.page++;
            _this.loadList(infiniteScroll, _this.token);
        }, 500);
        if (this.page >= this.maxPage) {
            infiniteScroll.enable(false);
        }
    };
    ReservasiPage.prototype.getData = function (token) {
        var _this = this;
        this.count = 0;
        this.errorsCount = 0;
        this.token = token;
        var loader = this.loading.show('Please Wait ....');
        loader.present().then(function () {
            _this.reservasi.ionCalendar(token).subscribe(function (data) { return _this.currentEvents = data; }, function (error) { return _this.requestError(loader); }, function () { return _this.requestDone(loader); });
            _this.profileService.profileInfo(token).subscribe(function (data) { return _this.profile = data.data; }, function (error) { return _this.requestError(loader); }, function () { return _this.requestDone(loader); });
        });
    };
    ReservasiPage.prototype.requestDone = function (loader) {
        this.count++;
        if (this.count == 2) {
            loader.dismiss();
        }
    };
    ReservasiPage.prototype.requestError = function (loader) {
        var _this = this;
        this.errorsCount++;
    ...
    ReservasiPage.prototype.listReservasi = function (event) {
        var date = __WEBPACK_IMPORTED_MODULE_3_moment__(event).format('DD/MM/YYYY');
        var dateParam = __WEBPACK_IMPORTED_MODULE_3_moment__(event).format('YYYY-MM-DD');
        this.rootNavCtrl.push('ListReservasiPage', {
            data: {
                date: date,
                unit_usaha_id: this.profile.unit_usaha_id,
            },
            token: this.token,
            dateParam: dateParam,
        });
    };
    ReservasiPage.prototype.goToDetails = function () {
    ...
    ], ReservasiPage.prototype, "content", void 0);
    ReservasiPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-reservasi',template:/*ion-inline-start:"/home/ari/Repos/Ionic/ClinicMobile/src/pages/reservasi/reservasi.html"*/'<!-- <ion-header>\n    <ion-navbar box-shadow>\n        <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n        <ion-title>Reservasi</ion-title>\n    </ion-navbar>\n</ion-header> -->\n\n<ion-content>\n  <ion-card-content *ngIf="currentEvents != undefined">\n		<button ion-button full (click)="goToDetails()">Open Details</button>\n    <ion-calendar #calendar [events]="currentEvents"  (onDaySelect)="listReservasi($event)"></ion-calendar>	\n  </ion-card-content>\n\n  <ion-item-divider box-shadow no-lines  ion-affix [content]="content" margin-bottom>\n  	Reservasi yang akan datang\n  </ion-item-divider>\n    \n    <ion-refresher (ionRefresh)="reload($event)">\n	  <ion-refresher-content></ion-refresher-content>\n	</ion-refresher>\n\n	<ion-list *ngIf="currentReservasi">\n	  <ion-item margin-bottom no-lines *ngFor="let item of currentReservasi" style="margin-bottom:11px">\n	  	<ion-card padding style="border-radius:5px;margin-bottom:3px;">\n		    <!-- Title -->\n		    <h2 item-title>{{item.unit_usaha}}</h2>\n		    <!-- Subtitle -->\n		    <h3 item-subtitle>{{item.no_reservasi}}</h3>\n		    <!-- Details Item-->\n		    <span span-medium style="margin-top:15px" float-right>{{item.tanggal}} {{item.waktu}}</span>\n		    <ion-badge float-left style="margin-top:10px;background-color: green">{{item.status}}</ion-badge>\n		</ion-card>\n	  </ion-item>\n	</ion-list>\n\n	<ion-infinite-scroll (ionInfinite)="loadMore($event)">\n	  <ion-infinite-scroll-content></ion-infinite-scroll-content>\n	</ion-infinite-scroll>\n</ion-content>'/*ion-inline-end:"/home/ari/Repos/Ionic/ClinicMobile/src/pages/reservasi/reservasi.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["NavController"],
            __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["NavParams"],
            __WEBPACK_IMPORTED_MODULE_5__providers_profile_service_profile_service__["a" /* ProfileServiceProvider */],
            __WEBPACK_IMPORTED_MODULE_6__providers_auth_service_auth_service__["a" /* AuthServiceProvider */],
            __WEBPACK_IMPORTED_MODULE_7__providers_loading_service_loading_service__["a" /* LoadingServiceProvider */],
            ...
            __WEBPACK_IMPORTED_MODULE_4__providers_modal_service_modal_service__["a" /* ModalServiceProvider */],
            __WEBPACK_IMPORTED_MODULE_9__providers_reservasi_service_reservasi_service__["a" /* ReservasiServiceProvider */],
...
//# sourceMappingURL=reservasi.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ReservasiPageModule", function() { return ReservasiPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__reservasi__ = __webpack_require__(1124);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ionic3_calendar_en__ = __webpack_require__(1074);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_ion_affix__ = __webpack_require__(891);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ReservasiPageModule = (function () {
    function ReservasiPageModule() {
    }
    ReservasiPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__reservasi__["a" /* ReservasiPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["IonicPageModule"].forChild(__WEBPACK_IMPORTED_MODULE_2__reservasi__["a" /* ReservasiPage */]),
                __WEBPACK_IMPORTED_MODULE_3_ionic3_calendar_en__["a" /* CalendarModule */],
                __WEBPACK_IMPORTED_MODULE_4_ion_affix__["a" /* IonAffixModule */]
            ],
        })
    ], ReservasiPageModule);
    return ReservasiPageModule;
}());
